...
{user.role !== "admin" && (
  ...
  Choose the membership plan that fits you best — whether it's Basic for essential access, Enterprise for team collaboration, or Premium for full-featured wellness benefits.
</p>
      <Link
  to="/membership"
